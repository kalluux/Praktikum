...
\begin{align*}
R_{m1} = (1,02 \pm 0,07) \si{\centi\meter}, %fehler richtig
\end{align*}
...
\begin{align*}
R_{m2} = (0,75 \pm 0,12) \si{\centi\meter}, %fehler richtig
\end{align*}
...
\begin{align*}
E_1 = (2,91 \pm 0,13) \si{\MeV}, %fehler 0,67?
\end{align*}
...
\begin{align*}
E_2 = (2,91 \pm 0,17) \si{\MeV}. %fehler richtig
\end{align*}
...
Var(N) = 78647 .
\end{align*}
%Die Funktion für die Gaußkurve lautet(wobei angenommen wird, dass die Wurzel der Varianz die Standardabweichung ist)
%\begin{align*}
%f(N_i,N,Var(N)) = \frac{1}{\Delta N \sqrt{2\pi}}\cdot e^{-\frac{1}{2}(\frac{N_i - N}{\Delta N})^2}.
%\end{align*}
