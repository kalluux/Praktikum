...
Daraus folgt für $RC$:
\begin{equation*}
    RC = -\frac{1}{a} = (1.21 \pm 0.03)\cdot 10^{-3} \si{\second} , 
\end{equation*}
...
\small
  ...
  \begin{tabular}{c c c c c c c c c c}
    ...
    \bottomrule
     10  & 7.8  & 0.00156 & 0.1 & 0.098 & 600 & 1.80 & 0.00036 & 0.0017 & 1.35 \\
     20  & 9.0 & 0.00144 & 0.05 & 0.181 & 700 & 1.56 & 0.00031 & 0.0014 & 1.138\\
     30  & 9.2& 0.0014 & 0.033 & 0.264 & 800 & 1.38 & 0.00028 & 0.0013 & 1.39\\
     40  & 9.0 & 0.00134 & 0.025 & 0.337 & 900 & 1.24 & 0.00025 & 0.0011 & 1.4\\
     50  & 8.8 & 0.00132 & 0.02 & 0.415 & 950 & 1.20 & 0.00024 & 0.0011 & 1.43\\
     60  & 8.4 & 0.0013 & 0.017 & 0.490 & 1000  & 1.12 & 0.00022 & 0.001 & 1.41\\
     70  & 8.2 & 0.00126 & 0.014 & 0.554 & 2000  & 0.54 & 0.00012 & 0.0005 & 1.47\\
     80  & 7.8 & 0.00122 & 0.013 & 0.613 & 3000  & 0.36 & 0.00008 & 0.0003 & 1.52\\
     90  & 7.6 & 0.00119 & 0.011 & 0.670 & 4000  & 0.28 & 0.00006 & 0.0003 & 1.52\\
...
\noindent Aus folgendem Zusammenhang
\begin{equation*}
    \frac{sin\phi}{cos\phi} = tan\phi(\omega) = -\omega RC ,
\end{equation*}
\noindent ergibt sich der Ansatz für diesen Graphen:
\begin{equation}
    y = arctan(2 \pi f  d) .
\end{equation}
\begin{figure}[H]
...
\begin{equation*}
  F(t) =
  \begin{cases}
    \frac{1}{2} \cdot Ut^2 & \text 0 < t < a \\
    -\frac{1}{2} \cdot Ut^2 & \text a < t < 2a .\\
  \end{cases}
\end{equation*}
\begin{figure}[H]
  \centering
